            ...
            <div id='publications'>
                <ol>
                    <li className="LiCategory">In scientific journals</li>
                        <ul>
                            <li className="LiItems">Febres M., Legendre D., Existence of Moffatt vortices at a moving contact line between two fluids. Phys. Rev. Fluids 2, 114002, June, 2017. <a className="HLink" href="https://doi.org/10.1103/PhysRevFluids.2.114002" target="_blank">DOI</a>, <Link className="LocalRepo" to="publications/vortices">[local repo]</Link>
                            </li>
                            <li className="LiItems">Febres M., Legendre D., Enhancement of a 2D front-tracking algorithm with a non-uniform distribution of lagrangian markers. Journal of Computational physics, July, 2017. <a className="HLink" href="https://doi.org/10.1016/j.jcp.2017.12.021" target="_blank">DOI</a>, <Link className="LocalRepo" to="publications/front-tracking">[local repo]</Link>
                            </li>
                        </ul>
                    <li className="LiCategory">In conferences</li>
                        <ul>
                            ...
                            <li className="LiItems"> Febres M., Berrios D. R., 2d finite volume computational code for fluid flow problems on unstructured meshes, In: VII Congreso Bolivariano de Ingenierı́a Mecánica - COBIM VII, Cusco - Perú, 2012. <a className="HLink" href="http://congreso.pucp.edu.pe/vii-cobim/B.4.1.pdf" target="_blank">Link</a>
                            </li>
                            <li className="LiItems"> Berrios D. R., Febres M., Machinery resonance analysis on vibration isolation, In: VII Congreso Bolivariano de Ingenierı́a Mecánica - COBIM VII, Cusco - Perú, 2012. <a className="HLink" href="http://congreso.pucp.edu.pe/vii-cobim/A.3.2.pdf" target="_blank">Link</a>.
                            </li>
                            <li className="LiItems"> Febres, M., Angela O. Nieckele., Slug flow prediction with the volume of fluid model. In: 13th Brazilian Congress of Thermal Sciences and Engineering, 2010, Uberlândia - Brazil, MG. Anais do 13th Brazilian Congress of Thermal Sciences and Engineering. Sao Paulo - Brazil: ABCM, 2010. p. 1-8. <a className="HLink" href="http://abcm.org.br/app/webroot/anais/encit/2010/PDF/ENC10-0537.pdf" target="_blank">Link</a>.
                            </li>
